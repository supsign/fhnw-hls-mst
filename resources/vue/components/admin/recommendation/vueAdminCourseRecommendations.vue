...
export default class VueAdminCourseRecommendations extends BaseComponent {
    ...
    public get courseRecommendations() {
        return this.models.courseRecommendation
            .filter((courseRecommendation) => courseRecommendation.recommendation_id === this.recommendationId)

    }

    public get courseRecommendationsInSemester() {
        return this.courseRecommendations.filter((courseRecommendation) => courseRecommendation.planned_semester === this.semester)
    }
    ...
    public addCourse() {
        ...
        this.models.courseRecommendation.post(
            {
