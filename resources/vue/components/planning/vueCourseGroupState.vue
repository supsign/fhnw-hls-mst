<template>
    <div class="border-l flex flex-row justify-end h-full">
        <div class="ml-4"><i aria-hidden="true" class="far fa-check-circle"></i> {{ completedCredits }}</div>
        <div class="ml-2"><i aria-hidden="true" class="far fa-calendar"></i> {{ plannedCredits }}</div>
